...
export class AudioStreamer {
  ...
  /**
   * Sets the output device for the audio context (if supported).
   * This allows routing audio to specific speakers/headphones.
   * @param deviceId The ID of the audio output device.
   */
  async setOutputDevice(deviceId: string) {
    // @ts-ignore - setSinkId is experimental in some types definitions
